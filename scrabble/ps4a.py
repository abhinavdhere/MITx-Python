...
WORDLIST_FILENAME = "/home/abhinav/edx_6.00.1x/scrabble/words.txt"
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand)!=0:# As long as there are still letters left in the hand:
        ...
        if word=='.':# If the input is a single period:
            ...
            return# End the game (break out of the loop)
...
def playGame(wordList):
    ...
    """
    while True:
      decide=raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
      try:          
        if decide=='n':
